...
main: $(h_files) $(c_files) main.c
	gcc -lm $(c_files) -std=gnu99 -lrt main.c -o main

main_debug: $(h_files) $(c_files) main.c
	gcc -D DEBUG -ggdb -lm $(c_files) -std=gnu99 -lrt main.c -o main_debug

test: $(h_files) $(c_files) test.c greatest.h
	gcc -D DEBUG -ggdb -lm $(c_files) -std=gnu99 -lrt test.c greatest.h -o test
